...
import  my_text_detector

USING_MY_TEXT_DETECOTR = True
...
class TextSystem(object):
    ...
    def __call__(self, img):
        ...
        if USING_MY_TEXT_DETECOTR:
            st = time.time()
            contours_list, cropped_images = my_text_detector.detect_text(
                img
            )
            det_elapse = time.time() - st

            dt_boxes = contours_list
            img_crop_list = cropped_images
